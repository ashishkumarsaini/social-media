...
function CarouselContent({ className, containerClass, ...props }: React.ComponentProps<"div"> & { containerClass?: string }) {
  const { carouselRef, orientation } = useCarousel();

  return (
    <div
      ref={carouselRef}
      className={cn("overflow-hidden", containerClass)}
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        canScrollPrev ? 'md:visible!' : 'md:invisible!',
        className
      )}
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        canScrollNext ? 'md:visible!' : 'md:invisible!',
        className
      )}
